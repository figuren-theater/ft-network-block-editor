...
/**
 * "Not all SVG’s are created equal.
 * I have had success with those that
 * define a square viewBox and
 * set a width and height of “1em”."
 * @see https://firxworx.com/blog/wordpress/custom-svg-icons-for-gutenberg-blocks-in-wordpress/
 */

const svg_fill = '#d20394'; // default pink
const bg_fill  = 'black';
...
export default () => (
    ...
    >
        ...
        <Path fill={svg_fill} d="M211.6 293c-8.3 2.6-12.3 12.9-8.1 21 5.3 10.3 20.4 10.1 25.4-.4 2.7-5.4 2.6-8.9 0-13.6-3.4-6-10.8-9-17.3-7z" />
